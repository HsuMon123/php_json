				...
				<form action="updatestudent.php" method="POST" enctype="multipart/form-data">
					...
					<div class="form-group row">
					    ...
					    <div class="col-sm-10">
					    	...
					    	<img src="" id="edit_img" width="100" height="100" class="d-block mt-2">
					    </div>
					</div>
					...
					$.each(stuArray,function(i,v){
						html+=`<tr>
							...
							<td>
								...
								data-gender="${v.gender}" data-email="${v.email}" data-address="${v.address}" data-profile="${v.profile}">Detail</button>
